...
menu.t_valuename = {
	...
	buttonjam = {
		...
		{itemname = 'q', displayname = motif.training_info.menu_valuename_buttonjam_d},
		{itemname = 'w', displayname = motif.training_info.menu_valuename_buttonjam_w},
                {itemname = 'h', displayname = motif.training_info.menu_valuename_buttonjam_h},
                {itemname = 't', displayname = motif.training_info.menu_valuename_buttonjam_t},
	},
}
