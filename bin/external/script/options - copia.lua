...
local btn = ''
local joyNum = 0
local t_btnNameNum = {up = 1, down = 2, left = 3, right = 4, a = 5, b = 6, c = 7, x = 8, y = 9, z = 10, start = 11, q = 12, w = 13, menu = 14}
local t_btnNumName = {'up', 'down', 'left', 'right', 'a', 'b', 'c', 'x', 'y', 'z', 'start', 'q', 'w', 'menu'}
local t_btnEnabled = {up = false, down = false, left = false, right = false, a = false, b = false, c = false, x = false, y = false, z = false, start = false, q = false, w = false, menu = false}
...
function options.f_keyDefault()
	...
	for i = 1, #config.KeyConfig do
		if i == 1 then
			btns = {up = 'UP', down = 'DOWN', left = 'LEFT', right = 'RIGHT', a = 'z', b = 'x', c = 'c', x = 'a', y = 's', z = 'a', start = 'RETURN', q = 'q', w = 'w'}
		elseif i == 2 then
