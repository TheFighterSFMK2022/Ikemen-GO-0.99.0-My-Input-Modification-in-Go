...
local t_keyCfg = {
	...
	{data = f_keyCfgText(), itemname = 'q', displayname = motif.option_info.keymenu_itemname_q, vardata = f_keyCfgText()},
	...
	{data = f_keyCfgText(), itemname = 'h', displayname = motif.option_info.keymenu_itemname_h, vardata = f_keyCfgText()},
	{data = f_keyCfgText(), itemname = 't', displayname = motif.option_info.keymenu_itemname_t, vardata = f_keyCfgText()},
...
local btn = ''
local joyNum = 0
local t_btnNameNum = {up = 1, down = 2, left = 3, right = 4, a = 5, b = 6, c = 7, x = 8, y = 9, z = 10, start = 11, q = 12, w = 13, h = 14, t = 15, menu = 16 }
local t_btnNumName = {'up', 'down', 'left', 'right', 'a', 'b', 'c', 'x', 'y', 'z', 'start', 'q', 'w','h', 't', 'menu' }
local t_btnEnabled = {up = false, down = false, left = false, right = false, a = false, b = false, c = false, x = false, y = false, z = false, start = false, q = false, w = false, h = false, t = false, menu = false}
...
function options.f_keyDefault()
	...
	for i = 1, #config.KeyConfig do
		if i == 1 then
			btns = {up = 'UP', down = 'DOWN', left = 'LEFT', right = 'RIGHT', a = 'z', b = 'x', c = 'c', x = 'a', y = 's', z = 'a', start = 'RETURN', q = 'q', w = 'w', h = 'h', t = 't', menu = v}
		elseif i == 2 then
			btns = {up = 'i', down = 'k', left = 'j', right = 'l', a = 'f', b = 'g', c = 'h', x = 'r', y = 't', z = 'y', start = 'RSHIFT', d = 'LBRACKET', w = 'RBRACKET', h = 'k', t = 'n', menu = m}
		else
			btns = {}
		end
	...
	btns = {up = '10', down = '12', left = '13', right = '11', a = '0', b = '1', c = '5', x = '2', y = '3', z = '-12', start = '7', d = '4', w = '-10', menu = '6', h = '12', t = '13'}
